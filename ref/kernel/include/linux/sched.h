...
/* journalling filesystem info */
	void *journal_info;
	int mq_first_trial_num;
};
/////////////////////////////////////////
/////////////////////////////////////////
void sched_set_switch_reason(struct task_struct *p, int reason);
extern void sched_start_logging(void);
...
extern void FASTCALL(wake_up_wake_up_father(task_t * tsk));
